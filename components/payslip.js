...
module.exports = function (payslip) {
  payslip.get("/payslip", function (req, res) {
    ...
    if (req.query.employeeID === undefined) {
      ...
      connection.query(
        ...
        function (err, EmployeeFound, fields) {
          ...
          totalEarnings = basicSalary + taxableAllowance + nonTaxableAllowance;
  ...
  payslip.post("/payslip", function (req, res) {
    ejs.renderFile(
  ...
  payslip.post("/employee-payslip-detalis", function (req, res) {
